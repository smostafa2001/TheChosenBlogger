...
namespace MasterBlogger.Presentation.RazorPages.Areas.Administrator.Pages.ArticleCategoryManagement
{
    public class ListModel : PageModel
    {
        ...
        public void OnGet() => ArticleCategories = _articleCategoryApplication.List();

...
using MasterBlogger.Infrastructure.Core;
...
namespace MasterBlogger.Presentation.RazorPages
{
    public class Startup
    {
        ...
        {
            Bootstrapper.Configure(services, Configuration.GetConnectionString("MasterBloggerDb"));         
